...
from ms_lab.asset_zoo.robots.unitree_go2.go2_constants import (
  GO2_ACTION_SCALE,
  GO2_ROBOT_CFG,
)
from ms_lab.tasks.velocity_mjc.velocity_env_cfg import (
...
@dataclass
class UnitreeGo2RoughEnvCfg(LocomotionVelocityEnvCfg):
  def __post_init__(self):
    ...
    go2_cfg = replace(GO2_ROBOT_CFG, sensors=tuple(foot_contact_sensors))
    self.scene.entities = {"robot": go2_cfg}
