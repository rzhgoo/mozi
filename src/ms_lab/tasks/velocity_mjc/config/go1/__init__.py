...
gym.register(
  id="ms_lab-Velocity-Rough-Unitree-Go1-Mjc",
...
gym.register(
  id="ms_lab-Velocity-Rough-Unitree-Go1-Mjc-Play",
  entry_point="ms_lab.envs:ManagerBasedRlEnv",
  disable_env_checker=True,
  kwargs={
...
gym.register(
  id="ms_lab-Velocity-Flat-Unitree-Go1-Mjc",
  entry_point="ms_lab.envs:ManagerBasedRlEnv",
  disable_env_checker=True,
  kwargs={
...
gym.register(
  id="ms_lab-Velocity-Flat-Unitree-Go1-Mjc-Play",
  entry_point="ms_lab.envs:ManagerBasedRlEnv",
  disable_env_checker=True,
  kwargs={
