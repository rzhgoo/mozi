...
from ms_lab.managers.manager_term_config import CurriculumTermCfg as CurrTerm
from ms_lab.managers.manager_term_config import EventTermCfg as EventTerm
from ms_lab.managers.manager_term_config import ObservationGroupCfg as ObsGroup
from ms_lab.managers.manager_term_config import ObservationTermCfg as ObsTerm
from ms_lab.managers.manager_term_config import RewardTermCfg as RewardTerm
from ms_lab.managers.manager_term_config import TerminationTermCfg as DoneTerm
...
from ms_lab.sim import MujocoCfg, SimulationCfg
from ms_lab.tasks.velocity_mjc import mdp
from ms_lab.terrains import TerrainImporterCfg
from ms_lab.terrains.config import ROUGH_TERRAINS_CFG
from ms_lab.utils.noise import UniformNoiseCfg as Unoise
...
class EventCfg:
  ...
  reset_base: EventTerm = term(
    ...
    mode="reset",
    params={
      "pose_range": {"x": (-0.5, 0.5), "y": (-0.5, 0.0), "yaw": (-3.14, 3.14)},
      "velocity_range": {},
    },
  )
...
class RewardCfg:
  ...
  base_linear_velocity: RewardTerm = term(
    RewardTerm,
  ...
  base_angular_velocity: RewardTerm = term(
    RewardTerm,
