...
def terrain_levels_vel(
  ...
  terrain = env._backend.get_terrain()
  ...
  distance = torch.norm(
    asset.data.root_link_pos_w[env_ids, :2] - env._backend.get_env_origins()[env_ids, :2], dim=1
  )



  # Robots that walked far enough progress to harder terrains.
  move_up = distance > terrain_generator.size[0] / 2-0.5
