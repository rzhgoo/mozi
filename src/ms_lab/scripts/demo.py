...
from ms_lab.scripts.gcs import ensure_default_checkpoint, ensure_default_motion
from ms_lab.scripts.play import PlayConfig, run_play


def main() -> None:
  """Run demo with pretrained tracking policy."""
  print("🎮 Setting up ms_lab demo with pretrained tracking policy...")
  ...
  run_play("ms_lab-Tracking-Flat-Unitree-G1-Play", args)
