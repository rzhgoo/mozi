...
CACHE_DIR = Path(tempfile.gettempdir()) / "ms_lab_cache"
...
ASSETS: dict[str, AssetInfo] = {
  "demo_ckpt.pt": {
    "url": "https://storage.googleapis.com/ms_lab_beta/model_6000.pt",
    "sha256": "4bc6338750464d6ad6b7b3d1eebd6b914fe40abbd184ffa1bccb9192068231de",
    "path": CACHE_DIR / "demo_ckpt.pt",
  },
  "demo_motion.npz": {
    "url": "https://storage.googleapis.com/ms_lab_beta/lafan_dance1_subject1.npz",
