...
class MaterialCfg(SpecCfg):
  ...
  def edit_spec(self, spec: mujoco.MjSpec) -> None:
    ...
    if self.texture is not None:
      ...
      mat.textures[rgb_role] = self.texture
...
class CollisionCfg(SpecCfg):
  ...
  def edit_spec(self, spec: mujoco.MjSpec) -> None:
    from ms_lab.utils.spec import disable_collision
    from ms_lab.utils.string import filter_exp, resolve_field
...
class ActuatorSetCfg(SpecCfg):
  ...
  def edit_spec(self, spec: mujoco.MjSpec) -> None:
    from ms_lab.utils.spec import get_non_free_joints, is_joint_limited
    from ms_lab.utils.string import filter_exp
